...
(function (factory) {
    ...
    var privateSettings = /** @class */ (function () {
        function privateSettings(settings) {
            this._settings = settings !== null && settings !== void 0 ? settings : {
        ...
        privateSettings.prototype.setSettings = function (newSettings) {
            // ... optional validation logic ...
            this._settings = newSettings;
        };
        privateSettings = __decorate([
            (0, inversify_1.injectable)(),
            __param(0, (0, inversify_1.inject)(exports.PRIVATE_SETTINGS_TOKEN)),
