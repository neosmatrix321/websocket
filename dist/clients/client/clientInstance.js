...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "systeminformation"], factory);
    }
    ...
    var clientWrapper = /** @class */ (function () {
        ...
        ;
        clientWrapper.prototype.create = function (newID, newIP) {
        ...
        clientWrapper.prototype.updateSettings = function (settings) {
            this._settings = __assign({}, settings); // Update settings with spread
            this._stats.eventCount++;
            this._stats.lastUpdates = { updateSettings: Date.now() };
        };
        clientWrapper.prototype.updateConfig = function (config) {
            if (config !== '{}') {
        ...
        clientWrapper.prototype.getClientLatency = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this._stats;
                            return [4 /*yield*/, systeminformation_1.default.inetLatency(this.info.ip)];
                        case 1:
                            _a.latency = _b.sent();
                            this._stats.eventCount++;
