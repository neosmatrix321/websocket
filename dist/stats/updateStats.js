...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "pidusage", "systeminformation", "./stats"], factory);
    }
    ...
    var updateGlobalStats = /** @class */ (function (_super) {
        __extends(updateGlobalStats, _super);
        function updateGlobalStats() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        updateGlobalStats.prototype.getLatencyGoogle = function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            _a = this.stats;
                            return [4 /*yield*/, (0, systeminformation_1.inetLatency)()];
                        case 2:
        ...
        updateGlobalStats.prototype.getSi = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, (0, systeminformation_1.processLoad)("PalServer-Linux")];
                        case 1:
        ...
        updateGlobalStats.prototype.getPu = function () {
            return __awaiter(this, void 0, void 0, function () {
                var usage, e_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        updateGlobalStats.prototype.comparePids = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
    ...
    exports.default = updateGlobalStats;
});
